        ...
        <div v-else>
          <el-form-item v-if="ruleForm.shipin" label="视频" prop="shipin">
            ...
            <el-col :span="24">
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.tuijianxiangqing" label="推荐详情" prop="tuijianxiangqing">
                    <span v-html="ruleForm.tuijianxiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `remenmeishi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.remenmeishiCrossAddOrUpdateFlag = false;
                  this.parent.search();
