...
public class MeishifenxiangController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,MeishifenxiangEntity meishifenxiang, HttpServletRequest request){

		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("yonghu")) {
			meishifenxiang.setYonghuming((String)request.getSession().getAttribute("username"));
		}
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,MeishifenxiangEntity meishifenxiang, HttpServletRequest request){
        EntityWrapper<MeishifenxiangEntity> ew = new EntityWrapper<MeishifenxiangEntity>();
		PageUtils page = meishifenxiangService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, meishifenxiang), params), params));
        return R.ok().put("data", page);
    }
